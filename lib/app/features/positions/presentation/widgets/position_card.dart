...
import 'package:on_stage_app/app/features/positions/presentation/providers/position_card_provider.dart';
...
class _PositionCardState extends ConsumerState<PositionCard> {
  ...
  Widget build(BuildContext context) {
    ...
    if (state.isEditing && _controller.text != state.position.title) {
      _controller.text = state.position.title;
