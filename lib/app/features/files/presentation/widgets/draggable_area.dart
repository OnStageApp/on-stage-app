...
// import 'package:collection/collection.dart'; // Added missing import for firstOrNull
...
//       if (_supportedFormats.values.any(lowercaseName.endsWith)) {
//         return '';
//       }
//     }
...
//       return _supportedFormats.keys.any(formatStr.contains);
//     });
...
//               // Await the asynchronous getFile callback.
