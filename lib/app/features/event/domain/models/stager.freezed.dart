...
class _$StagerImpl implements _Stager {
  ...
  @override
  String toString() {
    return 'Stager(id: $id, firstName: $firstName, lastName: $lastName, picture: $picture, email: $email, phone: $phone)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, firstName, lastName, picture, email, phone);
...
abstract class _Stager implements Stager {
  const factory _Stager(
      ...
      required final String phone}) = _$StagerImpl;
