...
// import 'package:on_stage_app/app/features/event/domain/models/stager/team_member_with_position.dart';
...
//                       .selectedTeamMemberWithPosition
//                       .isNotEmpty,
//                 );
//               },
//             ),
...
//                 .watch(eventControllerProvider)
//                 .addedStagerRequests
//                 .any((added) => added.teamMemberId == member.id),
//           )
//           .toList();
//     }
//     _searchedParticipants = _allParticipants;
...
//                                 teamMemberId: _searchedParticipants
//                                     .elementAt(index)
//                                     .userId,
//                                 userId: _searchedParticipants
//                                     .elementAt(index)
//                                     .userId,
//                                 positionId: widget.positionId,
//                                 groupId: widget.groupId,
//                                 profilePicture: _searchedParticipants
//                                     .elementAt(index)
//                                     .profilePicture,
//                                 name:
//                                     _searchedParticipants.elementAt(index).name,
