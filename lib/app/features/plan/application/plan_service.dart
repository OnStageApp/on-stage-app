...
const List<Plan> _staticPlans = [
  ...
  Plan(
    ...
    name: 'Solo Monthly',
    entitlementId: 'solo',
    revenueCatProductId: 'stage_solo_1m_1w0',
    price: 34.99,
    currency: 'RON',
    isYearly: false,
    maxEvents: 3,
  ...
  Plan(
    ...
    name: 'Solo Yearly',
    entitlementId: 'solo',
    revenueCatProductId: 'stage_solo_1y_1m0',
    price: 359.90,
    currency: 'RON',
    isYearly: true,
    maxEvents: 3,
  ...
  Plan(
    ...
    name: 'Pro Monthly',
    entitlementId: 'pro',
    revenueCatProductId: 'stage_pro_1m_1m0',
    price: 69.99,
    currency: 'RON',
    isYearly: false,
    maxEvents: 10,
  ...
  Plan(
    ...
    name: 'Pro Yearly',
    entitlementId: 'pro',
    revenueCatProductId: 'stage_pro_1y_1m0',
    price: 719,
    currency: 'RON',
    isYearly: true,
    maxEvents: 10,
  ...
  Plan(
    ...
    revenueCatProductId: 'stage_ultimate_1m_1m0',
    price: 149.99,
    currency: 'RON',
    isYearly: false,
    maxEvents: 30,
  ...
  Plan(
    ...
    entitlementId: 'ultimate',
    revenueCatProductId: 'stage_ultimate_1y_1m0',
    price: 1559.99,
    currency: 'RON',
    isYearly: true,
    maxEvents: 30,
