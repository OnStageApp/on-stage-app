...
const List<Plan> _staticPlans = [
  ...
  Plan(
    ...
    name: 'Solo Monthly',
    entitlementId: 'solo',
    revenueCatProductId: 's_onstage_solo_1m_1w0',
    price: 49.99,
    currency: 'RON',
    isYearly: false,
    maxEvents: 3,
  ...
  Plan(
    ...
    name: 'Solo Yearly',
    entitlementId: 'solo',
    revenueCatProductId: 's_onstage_solo_1y_1w0',
    price: 29.99,
    currency: 'RON',
    isYearly: true,
    maxEvents: 3,
  ...
  Plan(
    ...
    revenueCatProductId: 's_onstage_ultimate_1m_1m0',
    price: 129.99,
    currency: 'RON',
    isYearly: false,
    maxEvents: 30,
  ...
  Plan(
    ...
    entitlementId: 'ultimate',
    revenueCatProductId: 's_onstage_ultimate_1y_1m0',
    price: 109.99,
    currency: 'RON',
    isYearly: true,
    maxEvents: 30,
